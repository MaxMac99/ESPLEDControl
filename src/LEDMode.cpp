...
void LEDMode::setupCharacteristics() {
    ...
    onChar->setGetter(std::bind(&LEDAccessory::getOn, accessory));
...
void LEDMode::addBrightnessCharacteristic() {
    ...
    brightnessChar->setGetter(std::bind(&LEDAccessory::getBrightness, accessory));
...
void LEDMode::addHueCharacteristic() {
    ...
    hueChar->setGetter(std::bind(&LEDAccessory::getHue, accessory));
...
void LEDMode::addSaturationCharacteristic() {
    ...
    saturationChar->setGetter(std::bind(&LEDAccessory::getSaturation, accessory));
